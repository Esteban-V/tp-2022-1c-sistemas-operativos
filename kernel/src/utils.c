...
t_kernelConfig* getKernelConfig(char* path){
    ...
    kernelConfig->kernelIP = config_get_string_value(kernelConfig->config, "IP");
    kernelConfig->kernelPort = config_get_string_value(kernelConfig->config, "PUERTO");
    kernelConfig->memoryIP = config_get_int_value(kernelConfig->config, "IP_MEMORIA");
    ...
    kernelConfig->cpuPortDispatch = config_get_int_value(kernelConfig->config, "PUERTO_CPU_DISPATCH");
    kernelConfig->cpuPortInterrupt = config_get_int_value(kernelConfig->config, "PUERTO_CPU_INTERRUPT");
    kernelConfig->listenPort = config_get_double_value(kernelConfig->config, "PUERTO_ESCUCHA");
    ...
    kernelConfig->alpha = config_get_int_value(kernelConfig->config, "ALFA");
